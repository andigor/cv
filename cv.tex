...
\noindent\begin{tabular}{@{}lp{45mm}p{115mm}}
  ...
  Technologies: & \multicolumn{2}{p{160mm}}{C++, STL, Boost, concurrency, sqlite, icu, Java, Python, cmake, bash, vim, perforce, git, gdb, valgrind, metaprogramming, cmake, Linux, Android, OSX, iOS, asm,  TTD, scrum, jira, fisheye, confluence, NDS, ADASIS2}\\
\end{tabular}\\[7mm]
