...
{\color{lightgray}Senior software engineer\\Eindhoven, Netherlands}\\
{\color{lightgray}\hrule height 0.2mm}
\vspace{2mm}
\noindent
\textbf{PROFESSIONAL SUMMARY}\\
C++ software engineer with over 15 years of Linux/Windows development experience\\
...
\noindent\begin{tabular}{@{}lp{45mm}p{115mm}}
  Company: & \textbf{ABB Benelux, Eindhoven, Netherlands} & \multicolumn{1}{r}{07.2017 -- now}\\
  ...
  Project: & eXLerate & SCADA especially made for the control of oil and gas custody transfer systems. Operation, maintenance and management is highly automated. Measurement errors are automatically detected and even corrected. \\
  ...
  Technologies: & \multicolumn{2}{p{160mm}}{c++, boost, concurrency, modbus, hart, asm, windbg, excel, xll, com, c\#, visual basic, vba, bash, git, cmake, windows, wince, platform builder, android, canban, redmine, gerrit, cpputest, msvc, tdd, openxml, atl}\\
\end{tabular}\\[7mm]
\noindent\begin{tabular}{@{}lp{45mm}p{115mm}}
...
\noindent\begin{tabular}{@{}l>{\raggedright}p{45mm}p{115mm}}
  ...
  Positions: & Deputy director of informational technologies & development, debugging, review, requirements gathering, application engineering\\
  ~          & Head of Department of Informational technologies & development, debugging, review, requirements gathering, application engineering\\
  ~          & Head of projects & development, debugging, review, requirements gathering, application engineering\\
  ~          & Software engineer & development, debugging, review, application engineering\\
